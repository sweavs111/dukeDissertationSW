...
conforming to the 2023 Duke University guidelines.  This class is by
Michael Gratton and modified by Hugh Crumley, Mitchell Abrams (2023), and Michael Gao (2025).  It is based on the 2004 \LaTeX2$\epsilon$ version of
...
This class conforms to the 2023 style guidelines for dissertations,
including:
\begin{enumerate}
...
By default, the figure and table captions are set to print centered with \texttt{centering}. Change the \texttt{\textbackslash captionsetup} option in the preamble to adjust this to either \texttt{justified} or \texttt{raggedright} as desired.

\section{Limitations}
In it's current form, this class does not support committees larger than
six members, or titles longer than four lines.  The figure-to-caption space has been abbreviated, as most plotting programs provide ample bottom margins.  This default may not be acceptable in all
cases.
...
\begin{description}
	...
	\item[nogradschool] Supresses the above.
